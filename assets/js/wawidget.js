(function(phoneNumber, logo, name) {
  document.write(`<div class="whatsapp-widget" style="position:fixed;bottom:20px;right:20px;display:flex;flex-direction:column;align-items:flex-end;z-index:1000;">
    <div class="chat-box" style="display:none;background:white;width:280px;padding:10px;box-shadow:0px 4px 6px rgba(0, 0, 0, 0.1);border-radius:8px;margin-bottom:10px;">
      ...
      <p style="font-size:14px;color:#555;">Hi! How can we assist you today?</p>
      <a id="whatsapp-link" href="#" target="_blank" style="display:block;text-align:center;background:#25D366;color:white;padding:8px;border-radius:5px;text-decoration:none;">Open WhatsApp</a>
    </div>
...
})(window.phoneNumber, window.logo, window.name);
